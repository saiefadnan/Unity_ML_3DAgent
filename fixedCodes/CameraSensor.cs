...
namespace Unity.MLAgents.Sensors
{
    ...
    public class CameraSensor : ISensor, IBuiltInSensor, IDisposable
    {
        ...
        public CameraSensor(
            ...
            SensorCompressionType compression, ObservationType observationType = ObservationType.Default)
        {
            m_Camera = camera;
            m_Width = width;
            m_Height = height;
        ...
        public static void ObservationToTexture(Camera obsCamera, Texture2D texture2D, int width, int height)
        {
            ...
            texture2D.Apply(); // Required after ReadPixels to upload pixel data to GPU
        ...
        public void Dispose()
        {
            ...
            {
                // Use Destroy vs DestroyImmediate depending on play state
