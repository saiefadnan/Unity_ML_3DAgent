namespace Unity.MLAgents.Sensors
{
    ...
    public struct ObservationSpec
    {
        ...
        {
            var dimProps = new InplaceArray<DimensionProperty>(
                DimensionProperty.TranslationalEquivariance,  // height
                DimensionProperty.TranslationalEquivariance,  // width
                DimensionProperty.None                         // channels
            );
            return new ObservationSpec(
                new InplaceArray<int>(height, width, channels), // HWC — correct order
                dimProps,
                obsType
            );
        }
